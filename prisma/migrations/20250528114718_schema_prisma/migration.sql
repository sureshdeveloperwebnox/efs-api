...
CREATE TABLE "user_role_assignments" (
    ...
    "assigned_at" VARCHAR(50) NOT NULL DEFAULT '',
    "created_at" VARCHAR(50) NOT NULL DEFAULT '',
    "updated_at" VARCHAR(50) NOT NULL DEFAULT '',
...
CREATE TABLE "crew_members" (
    "id" BIGSERIAL NOT NULL,
    "organization_id" BIGINT NOT NULL,
    "crew_id" BIGINT NOT NULL DEFAULT 0,
    "user_id" BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE "maintenance_plans" (
    ...
    "frequency_unit" INTEGER NOT NULL DEFAULT 0,
    "frequency_unit_type" "FrequencyUnitType" NOT NULL DEFAULT 'DAYS',
...
-- CreateIndex
CREATE INDEX "holidays_organization_idx" ON "holidays"("organization_id");
...
-- AddForeignKey
ALTER TABLE "crew_members" ADD CONSTRAINT "crew_members_crew_id_fkey" FOREIGN KEY ("crew_id") REFERENCES "crews"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "work_order_crew" ADD CONSTRAINT "work_order_crew_crew_id_fkey" FOREIGN KEY ("crew_id") REFERENCES "crews"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
